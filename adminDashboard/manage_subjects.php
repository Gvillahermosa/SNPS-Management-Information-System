...
if (isset($_SESSION['id']) && isset($_SESSION['user_name'])) {
    ...
    $sql = "
    SELECT id, level, section, subject_name
    FROM subjects
    ";
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../Assets/css/manage_subjects.css">
    ...
    <body>
        ...
        <div class="body-contents">
            ...
            <div class="bread-crumb">
                <p><span class="fa-solid--home"></span> Home / Student / Manage Subject</p>
            </div>
            <div class="dashboard">
                <p>View Subjects Info</p>
                <div class="datatable">
