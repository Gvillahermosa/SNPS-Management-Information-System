...
if (isset($_SESSION['id']) && isset($_SESSION['user_name'])) {
    if (isset($_GET['id'])) {
        ...
        $error_message = "No teacher selected.";
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt = $conn->prepare($update_sql)) {
        ...
        if ($stmt->execute()) {
            ...
            $error_message = "Failed to update teacher information: " . $stmt->error;
        }
        $stmt->close();
    } else {
...
<title>SNPS MIS</title>
    <link rel="stylesheet" type="text/css" href="../Assets/css/teacher_dashboard/edit_teacher.css">
    ...
    <div class="body-contents">
        ...
        <div class="dashboard">
            ...
            <div class="form-container">
                ...
                <a href="teacher_dashboard.php?id=<?= $teacher['id']; ?>" class="btn btn-primary">
