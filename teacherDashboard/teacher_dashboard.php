...
// Check if the user is logged in and if they are a teacher
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Assets/css/teacher_dashboard/teacher_profile.css">
    ...
    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="2">No class load records found.</td>
                    </tr>
                <?php endif; ?>
